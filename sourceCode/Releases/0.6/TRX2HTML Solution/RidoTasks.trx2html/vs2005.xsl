	...
	<xsl:template match="/">
		<html>
			...
			<body onload="summary();">
				...
				<i style="width:100%;font:10pt Verdana;text-align:center;background-color:#dcdcdc">The VSTS Test Results HTML Viewer. (c) <a href="http://blogs.msdn.com/rido">rido</a>'2010</i>
			</body>
		</html>
	</xsl:template>
