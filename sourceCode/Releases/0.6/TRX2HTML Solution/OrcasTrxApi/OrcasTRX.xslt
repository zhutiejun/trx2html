...
>
  ...
  <xsl:template match="/" >
    ...
    <html>
      <head>
        <link type="text/css" rel="StyleSheet"  href="D:\rido\atCodePlex\trx2html\TRX2HTML Solution\OrcasTrxApi\trx2html.css"   />
        <script language="javascript" type="text/javascript" src="D:\rido\atCodePlex\trx2html\TRX2HTML Solution\OrcasTrxApi\trx2html.js"></script>
        <title>
          TRX Report -
      ...
      <body onload="summary();">
        ...
        <i style="width:100%;font:10pt Verdana;text-align:center;background-color:#dcdcdc">
          The VSTS Test Results HTML Viewer. (c) <a href="http://blogs.msdn.com/rido">rido</a>'08
        </i>
